...
export default function PdfTemplate({ report, onClose }) {
  ...
  function handlePrintPdf() {
    ...
    document.title = `បង្កាន់ដៃសំណើរថយន្ត-${requestId}`;
    const restoreTitle = () => {
  ...
  async function handleSavePdfFile() {
    ...
    try {
      const fileName = `បង្កាន់ដៃសំណើរថយន្ត-${requestId}.pdf`;
      ...
      console.error(error);
      window.alert("មិនអាចរក្សាទុកឯកសារ PDF ទៅក្នុងកុំព្យូទ័របានទេ។ សូមព្យាយាមម្ដងទៀត។");
    } finally {
    ...
    <div className="pdf-preview-overlay" role="dialog" aria-modal="true" aria-labelledby="pdfTitle">
      <div className="pdf-preview-shell">
        <div className="pdf-preview-actions">
          ...
          <button className="ghost" type="button" onClick={handlePrintPdf}>
            បោះពុម្ព
          </button>
        ...
        <article id="pdfTemplate" className="pdf-document">
          ...
          <section className="pdf-status-row">
            ...
            <div className="pdf-status-badge">បានអនុម័ត</div>
          </section>
          ...
          <section className="pdf-grid">
            ...
            <section className="pdf-panel">
              <h3>ព័ត៌មានកញ្ចប់រថយន្ត</h3>
              <div className="pdf-row">
                <div className="pdf-label">ប្រភេទកញ្ចប់</div>
                <div className="pdf-value">កញ្ចប់ថេរ ៣ រថយន្ត</div>
              </div>
              <div className="pdf-row">
                <div className="pdf-label">រថយន្តទី ១</div>
                <div className="pdf-value">រថយន្តដឹកជញ្ជូន (៥ នាក់)</div>
              </div>
              <div className="pdf-row">
                <div className="pdf-label">រថយន្តទី ២</div>
                <div className="pdf-value">រថយន្តមេបញ្ជាការ (៥ នាក់)</div>
              </div>
              <div className="pdf-row">
                <div className="pdf-label">រថយន្តទី ៣</div>
                <div className="pdf-value">រថយន្តបច្ចេកទេស (៥ នាក់)</div>
              </div>
              <div className="pdf-row">
                <div className="pdf-label">សមត្ថភាពសរុប</div>
                <div className="pdf-value">១៥ នាក់/បេសកកម្ម</div>
              </div>
            </section>
            ...
            <section className="pdf-panel">
              ...
              <div className="pdf-row">
                ...
                <div className="pdf-value pdf-value-success">បានអនុម័ត</div>
              </div>
              <div className="pdf-row">
                <div className="pdf-label">ពិនិត្យដោយ</div>
                <div className="pdf-value">ប្រព័ន្ធស្នើសុំរថយន្ត MCCTV</div>
              </div>
              <div className="pdf-row">
